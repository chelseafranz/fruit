...
$googlefonts = array(
				$smof_data['thz_body_text']['face'],
				$smof_data['thz_heading_h1']['face'],
				$smof_data['thz_heading_h2']['face'],
				$smof_data['thz_heading_h3']['face'],
				$smof_data['thz_heading_h4']['face'],
				$smof_data['thz_heading_h5']['face'],
				$smof_data['thz_heading_h6']['face'],			
				$smof_data['thz_menu']['face'],
				$smof_data['thz_footer']['face'],
				$smof_data['thz_heading_subtitle']['face']
				);
